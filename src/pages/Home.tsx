...
const technologies = [
  { name: "AI Builder", icon: "/assets/AIBuilder.svg" },
  { name: "Azure", icon: "/assets/Microsoft_Azure.svg" },
  { name: "Copilot", icon: "/assets/copilot.svg" },
  { name: "Copilot Studio", icon: "/assets/CopilotStudio.svg" },
  { name: "Csharp", icon: "/assets/Csharp.svg" },
  { name: "Dataverse", icon: "/assets/Dataverse.svg" },
  { name: "GitHub", icon: "/assets/GitHub.svg" },
  { name: ".NET", icon: "/assets/dotnet.svg" },
  { name: "LATEX", icon: "/assets/latex.svg" },
  { name: "Microsoft 365", icon: "/assets/Microsoft365.svg" },
  { name: "Node.js", icon: "/assets/node-js.svg" },
  { name: "OpenAI", icon: "/assets/OpenAI.png" },
  { name: "Perplexity", icon: "/assets/Perplexity.svg" },
  { name: "Power Apps", icon: "/assets/PowerApps.svg" },
  { name: "Power Automate", icon: "/assets/PowerAutomate.svg" },
  { name: "Power BI", icon: "/assets/PowerBI.svg" },
  { name: "PowerFx", icon: "/assets/PowerFx.svg" },
  { name: "PowerPages", icon: "/assets/PowerPages.svg" },
  { name: "PowerShell", icon: "/assets/powershell.svg" },
  { name: "Python", icon: "/assets/Python.svg" },
  { name: "React.js", icon: "/assets/React.svg" },
  { name: "SharePoint", icon: "/assets/SharePoint.svg" },
  { name: "SPFx", icon: "/assets/SharePointFramework.svg" },
